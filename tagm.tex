...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in enrichGO(gene = rownames(fData(andyMCMChl))[fData(andyMCMChl)\$outlier.allocation < : could not find function "{}enrichGO"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'ego' not found}}\begin{verbatim}
## pdf 
##   2
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'egobp' not found}}\begin{verbatim}
## pdf 
##   2
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'egoMF' not found}}\begin{verbatim}
## pdf 
##   2
\end{verbatim}
\end{kframe}
