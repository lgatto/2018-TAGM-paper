...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in density.default(x, weights = w, bw = bw, adjust = adjust, kernel = kernel, : sum(weights) != 1\ \ -- will not get true density}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in density.default(x, weights = w, bw = bw, adjust = adjust, kernel = kernel, : sum(weights) != 1\ \ -- will not get true density}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in title(main = "{}Profile of Protein Q924C1 with marker distributions"{}): plot.new has not been called yet}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in title(main = "{}Profile of Protein Q9WUA2 with marker distributions"{}): plot.new has not been called yet}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in title(main = "{}Profile of Protein Q8VDR9 with marker distributions "{}): plot.new has not been called yet}}
