...
\author[1,2,4]{Laurent Gatto\thanks{\url{lg390@cam.ac.uk}}~}
...
<<pca12, echo=FALSE>>=
par(mar = c(4,4,2,0))
tiff("Fig1a.tiff", units="in", width=10, height=10, res=300)
...
<<pca14, echo=FALSE>>=
par(mar = c(4,4,2,0))
tiff("Fig1b.tiff", units="in", width=10, height=10, res=300)
...
par(mfrow = c(1,1))
tiff("Fig2a.tiff", units="in", width=10, height=10, res=300)
...
par(mfrow = c(1,1))
tiff("Fig2b.tiff", units="in", width=10, height=10, res=300)
...
par(mar = c(4,4,2,0))
tiff("Fig3a.tiff", units="in", width=10, height=10, res=300)
...
par(mar = c(4,4,2,0))
tiff("Fig3b.tiff", units="in", width=10, height=10, res=300)
...
tiff("Fig4.tiff", units="in", width=10, height=10, res=300)
print(gg)
dev.off()
@
...
tiff("Fig5.tiff", units="in", width=10, height=10, res=300)
print(gg)
dev.off()
@
...
tiff("Fig6.tiff", units="in", width=10, height=10, res=300)
print(gg2)
dev.off()
@
...
tiff("Fig7a.tiff", units="in", width=10, height=10, res=300)
...
tiff("Fig7b.tiff", units="in", width=10, height=10, res=300)
...
gg2 <- gg2 +
    theme(legend.position="none")
tiff("Fig8a.tiff", units="in", width=10, height=10, res=300)
print(gg2)
dev.off()
@
    \caption{}
...
tiff("Fig8b.tiff", units="in", width=10, height=10, res=300)
...
gg <- gg + theme_bw()
tiff("Fig8c.tiff", units="in", width=10, height=10, res=300)
print(gg)
dev.off()
@
    \caption{}
...
prots <- "Q924C1"
par(oma = c(0,0,0,0))
tiff("Fig8d.tiff", units="in", width=10, height=10, res=300)
...
tiff("Fig9a.tiff", units="in", width=10, height=10, res=300)
print(gg2)
dev.off()
@
    \caption{}
...
par(mar=c(5,6,4,2)+1, las = 2)
par(mai = c(2,0,1,0), oma = c(0,0,0,0))
tiff("Fig9b.tiff", units="in", width=10, height=10, res=300)
hlo <- andyMCMChl[, order(andyMCMChl$Iodixonal.Density)]
...
gg <- gg + theme_bw()
tiff("Fig9c.tiff", units="in", width=10, height=10, res=300)
print(gg)
dev.off()
@
    \caption{}
...
prots <- "Q9WUA2"
tiff("Fig9d.tiff", units="in", width=10, height=10, res=300)
par(oma = c(0,0,0,0))
foi13s <- FeaturesOfInterest(description = "",
                             fnames = prots,
                             object = andyMCMChl)
...
gg2 <- gg2 +
    theme(legend.position="none")
tiff("Fig10a.tiff", units="in", width=10, height=10, res=300)
print(gg2)
dev.off()
@
    \caption{}
...
par(mar=c(5,6,4,2)+1, las = 2)
par(mai = c(2,0,1,0), oma = c(0,0,0,0))
tiff("Fig10b.tiff", units="in", width=10, height=10, res=300)
hlo <- andyMCMChl[, order(andyMCMChl$Iodixonal.Density)]
...
gg <- gg + theme_bw()
tiff("Fig10c.tiff", units="in", width=10, height=10, res=300)
print(gg)
dev.off()
@
    \caption{}
...
names(ptsze) <- rownames(fData(andyMCMChl))
ptsze[as.numeric(fData(andyMCMChl)$outlier.allocation) <0.99995] <- 0.1
tiff("Fig10d.tiff", units="in", width=10, height=10, res=300)
plot2D(andyMCMChl, fcol = "predicted.allocation", cex = ptsze,
...
par(mfrow = c(1,1))
tiff("Fig11a.tiff", units="in", width=10, height=10, res=300)
...
names(ptsze) <- rownames(fData(andyMCMChl))
ptsze[as.numeric(fData(andyMCMChl)$outlier.allocation) <0.9999] <- 0.1
tiff("Fig11b.tiff", units="in", width=10, height=10, res=300)
par(mfrow = c(1,1))
...
par(mar = c(4,4,2,0))
tiff("Fig11c.tiff", units="in", width=10, height=10, res=300)
...
tiff("Fig14.tiff", units="in", width=10, height=10, res=300)
...
par(mfrow = c(2,3))
tiff("Fig15a.tiff", units="in", width=10, height=10, res=300)
...
dev.off()
tiff("Fig15b.tiff", units="in", width=10, height=10, res=300)
...
dev.off()
tiff("Fig15c.tiff", units="in", width=10, height=10, res=300)
...
dev.off()
tiff("Fig15d.tiff", units="in", width=10, height=10, res=300)
...
dev.off()
tiff("Fig15e.tiff", units="in", width=10, height=10, res=300)
...
dev.off()
tiff("Fig15f.tiff", units="in", width=10, height=10, res=300)
...
par(mar = c(0,0,0,0), mai = c(2,0,0,0), oma = c(0,0,0,0))
tiff("Fig17.tiff", units="in", width=10, height=10, res=300)
lattice.options(
  layout.heights=list(bottom.padding=list(x=0), top.padding=list(x=0)),
  layout.widths=list(left.padding=list(x=0), right.padding=list(x=0))
)
