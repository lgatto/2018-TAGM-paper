...
par(mar = c(4,4,2,0))
plotEllipse(hl, method = "MAP", components = c(1,4), main = "Visualisation along 1st and 4th principal components")
...
<<fig=TRUE, echo=FALSE, fig.width = 3, fig.height = 3,fig.align="center">>=>>=
par(mar = c(4,4,2,0))
plotEllipse(hl, method = "MCMC", components = c(1,4), main = "Visualisation along the 1st and 4th principal component")
